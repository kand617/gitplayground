...
public class FormParamsController extends BaseController {
    ...
    public FormParamsController(HttpClient _client) {
        super(_client);
    }
    ...
    public void sendIntegerArrayAsync(
        ...
        queryBuilder.append("/form/number?array=true");
        //validate and preprocess url
        String queryUrl = APIHelper.cleanUrl(queryBuilder);

        //load all headers for the outgoing API request
        Map<String, String> headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5248711025536551289L;
            {
        ...
        Map<String, Object> parameters = new HashMap<String, Object>() {
            private static final long serialVersionUID = 5694024005220390436L;
            {
                    put( "array", array );
            }
        };
    ...
    public void sendStringArrayAsync(
        ...
        //prepare query string for API call
        StringBuilder queryBuilder = new StringBuilder(baseUri);
        queryBuilder.append("/form/string?array=true");
        //validate and preprocess url
        String queryUrl = APIHelper.cleanUrl(queryBuilder);

        //load all headers for the outgoing API request
        Map<String, String> headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4617276669299665999L;
            {
                    put( "user-agent", "Stamplay SDK" );
                    put( "accept", "application/json" );
            }
        ...
        //load all fields for the outgoing API request
        Map<String, Object> parameters = new HashMap<String, Object>() {
            private static final long serialVersionUID = 5707833842917595143L;
            {
                    put( "array", array );
            }
        };
    ...
    public void sendModelAsync(
        ...
        //load all headers for the outgoing API request
        Map<String, String> headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4617751671797176415L;
            {
                    put( "user-agent", "Stamplay SDK" );
                    put( "accept", "application/json" );
            }
        ...
        //load all fields for the outgoing API request
        Map<String, Object> parameters = new HashMap<String, Object>() {
            private static final long serialVersionUID = 4706016428240133745L;
            {
                    put( "model", model );
            }
        };
    ...
    public void sendModelArrayAsync(
        ...
        //prepare query string for API call
        StringBuilder queryBuilder = new StringBuilder(baseUri);
        queryBuilder.append("/form/model?array=true");
        //validate and preprocess url
        String queryUrl = APIHelper.cleanUrl(queryBuilder);

        //load all headers for the outgoing API request
        Map<String, String> headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4918211689248546980L;
            {
                    put( "user-agent", "Stamplay SDK" );
                    put( "accept", "application/json" );
            }
        ...
        //load all fields for the outgoing API request
        Map<String, Object> parameters = new HashMap<String, Object>() {
            private static final long serialVersionUID = 5067084979690522101L;
            {
                    put( "array", array );
            }
        };
    ...
    /**
     * TODO: type endpoint description here
     * @param    file    Required parameter: TODO: type description here
	 * @return	Returns the ServerResponse response from the API call*/
    public void sendFileAsync(
        ...
        //load all headers for the outgoing API request
        Map<String, String> headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4633544621263388309L;
            {
                    put( "user-agent", "Stamplay SDK" );
                    put( "accept", "application/json" );
            }
        ...
        //load all fields for the outgoing API request
        Map<String, Object> parameters = new HashMap<String, Object>() {
            private static final long serialVersionUID = 5310909980394754829L;
            {
                    put( "file", file );
            }
        };
    ...
    public void sendMixedArrayAsync(
        ...
        //load all headers for the outgoing API request
        Map<String, String> headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5457033950561906933L;
            {
                    put( "user-agent", "Stamplay SDK" );
                    put( "accept", "application/json" );
            }
        ...
        //load all fields for the outgoing API request
        Map<String, Object> parameters = new HashMap<String, Object>() {
            private static final long serialVersionUID = 5266154260991474529L;
            {
                    put( "file", input.getFile() );
                    put( "models", input.getModels() );
                    put( "numbers", input.getNumbers() );
    ...
    public void sendStringAsync(
        ...
        //load all headers for the outgoing API request
        Map<String, String> headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5674270113206983999L;
            {
                    put( "user-agent", "Stamplay SDK" );
                    put( "accept", "application/json" );
            }
        ...
        //load all fields for the outgoing API request
        Map<String, Object> parameters = new HashMap<String, Object>() {
            private static final long serialVersionUID = 5692577590515776458L;
            {
                    put( "value", value );
            }
        };
    ...
    public void sendIntegerEnumArrayAsync(
        ...
        //prepare query string for API call
        StringBuilder queryBuilder = new StringBuilder(baseUri);
        queryBuilder.append("/form/integerenum?array=true");
        //validate and preprocess url
        String queryUrl = APIHelper.cleanUrl(queryBuilder);

        //load all headers for the outgoing API request
        Map<String, String> headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5026658163880139604L;
            {
                    put( "user-agent", "Stamplay SDK" );
                    put( "accept", "application/json" );
            }
        ...
        //load all fields for the outgoing API request
        Map<String, Object> parameters = new HashMap<String, Object>() {
            private static final long serialVersionUID = 5662660201709230853L;
            {
    ...
    public void sendStringEnumArrayAsync(
        ...
        //prepare query string for API call
        StringBuilder queryBuilder = new StringBuilder(baseUri);
        queryBuilder.append("/form/stringenum?array=true");
        //validate and preprocess url
        String queryUrl = APIHelper.cleanUrl(queryBuilder);

        //load all headers for the outgoing API request
        Map<String, String> headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5690160959383183456L;
            {
                    put( "user-agent", "Stamplay SDK" );
                    put( "accept", "application/json" );
            }
        ...
        //load all fields for the outgoing API request
        Map<String, Object> parameters = new HashMap<String, Object>() {
            private static final long serialVersionUID = 4920292979028381883L;
            {
                    put( "array", (null != array) ? array.value() : null );
            }
        };
