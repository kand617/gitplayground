...
public class ResponseTypesController extends BaseController {
     ...
     */
    public ResponseTypesController() {
        super();
    }
    ...
    public ResponseTypesController(HttpClient _client) {
        super(_client);
    }
    ...
    public void getPrecisionAsync(
        ...
        Map<String, String> headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5710267634374288196L;
            {
    ...
    public void getBinaryAsync(
        ...
        //load all headers for the outgoing API request
        Map<String, String> headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5251769369659216688L;
            {
                    put( "user-agent", "Stamplay SDK" );
            }
        };
    ...
    public void getIntegerAsync(
        ...
        //load all headers for the outgoing API request
        Map<String, String> headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5198994167358611197L;
            {
                    put( "user-agent", "Stamplay SDK" );
            }
        };
                ...
                clientInstance.executeAsStringAsync(request, new APICallBack<HttpResponse>() {
                    public void onSuccess(HttpContext context, HttpResponse response) {
                        try {
                            ...
                            //extract result from the http response
                            Integer result = ((HttpStringResponse)response).getBody();
